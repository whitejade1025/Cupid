  ...
  [437],
  {
    ...
    1119: (e, t, n) => {
      ...
      class _default extends elementorModules.Module {
        constructor() {
          super(),
            elementorFrontend.config.experimentalFeatures["floating-buttons"] &&
              ([
                ...
                elementorFrontend.elementsHandler.attachHandler(e, () =>
                  n.e(8).then(n.bind(n, 5051))
                );
              }),
              elementorFrontend.elementsHandler.attachHandler(
                "contact-buttons-var-10",
                () => n.e(322).then(n.bind(n, 4833))
              ));
        }
      }
      t.default = _default;
        ...
        constructor() {
          super(),
            elementorFrontend.elementsHandler.attachHandler("search", [
              () => n.e(464).then(n.bind(n, 6510)),
              () => n.e(464).then(n.bind(n, 8889)),
            ]);
        }
      }
      t.default = _default;
