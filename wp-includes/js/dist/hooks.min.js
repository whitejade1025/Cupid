      ...
      507: (t, e, r) => {
        ...
        var o = function (t, e) {
          return function (r, o, s, c = 10) {
            ...
            const a = { callback: s, priority: c, namespace: o };
            if (l[r]) {
        ...
        var s = function (t, e, r = !1) {
          return function (o, s) {
            ...
            let l = 0;
            if (r)
              (l = c[o].handlers.length),
                (c[o] = { runs: c[o].runs, handlers: [] });
            else {
        ...
        var c = function (t, e) {
          return function (r, n) {
            const i = t[e];
            return void 0 !== n
              ? r in i && i[r].handlers.some((t) => t.namespace === n)
              : r in i;
          };
        };
              ...
              n
                ? async function () {
                    try {
                      ...
                      for (; l.currentIndex < c.length; ) {
                        ...
                        (t = await e.callback.apply(null, o)),
                          r && (o[0] = t),
                          l.currentIndex++;
                      }
                      return r ? t : void 0;
                ...
                : function () {
                    try {
                      ...
                      let t = r ? o[0] : void 0;
                      for (; l.currentIndex < c.length; ) {
                        (t = c[l.currentIndex].callback.apply(null, o)),
                          r && (o[0] = t),
                          l.currentIndex++;
                      }
                      return r ? t : void 0;
        ...
        var d = function (t, e) {
          return function (r) {
            ...
            return void 0 === r
              ? n.__current.size > 0
              : Array.from(n.__current).some((t) => t.name === r);
          };
        };
        var u = function (t, e) {
          return function (r) {
        ...
        class h {
          ...
          constructor() {
            (this.actions = Object.create(null)),
              ...
              (this.removeAction = s(this, "actions")),
              (this.removeFilter = s(this, "filters")),
              (this.hasAction = c(this, "actions")),
              (this.hasFilter = c(this, "filters")),
              (this.removeAllActions = s(this, "actions", !0)),
              (this.removeAllFilters = s(this, "filters", !0)),
              (this.doAction = l(this, "actions", !1, !1)),
              (this.doActionAsync = l(this, "actions", !1, !0)),
              (this.applyFilters = l(this, "filters", !0, !1)),
              (this.applyFiltersAsync = l(this, "filters", !0, !0)),
              (this.currentAction = a(this, "actions")),
              (this.currentFilter = a(this, "filters")),
              (this.doingAction = d(this, "actions")),
              (this.doingFilter = d(this, "filters")),
