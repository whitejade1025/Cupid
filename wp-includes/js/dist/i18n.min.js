...
(() => {
      ...
      return (
        ...
        t.replace(o, function () {
          ...
          return (
            ...
            "%" === (i = arguments[9])
              ? "%"
              : ("*" === (a = arguments[7]) && ((a = n[e]), e++),
                void 0 === r
                  ? (void 0 === t && (t = e + 1), e++, (o = n[t - 1]))
                  : n[0] &&
                    "object" == typeof n[0] &&
                    n[0].hasOwnProperty(r) &&
                    (o = n[0][r]),
                "f" === i
                  ? (o = parseFloat(o) || 0)
                  : "d" === i && (o = parseInt(o) || 0),
  ...
  function u(t) {
    var n = (function (t) {
      for (var n, o, l, s, u = [], d = []; (n = t.match(i)); ) {
        for (
          o = n[0], (l = t.substr(0, n.index).trim()) && u.push(l);
          (s = d.pop());
  ...
  var d = { contextDelimiter: "", onMissingKey: null };
  function c(t, n) {
    var e;
    ...
    (this.options = {}),
    d))
      this.options[e] = void 0 !== n && e in n ? n[e] : d[e];
  }
  (c.prototype.getPluralForm = function (t, n) {
    ...
    (c.prototype.dcnpgettext = function (t, n, e, r, a) {
      ...
      return (
        ...
        (o = e),
        n && (o = n + this.options.contextDelimiter + e),
        (l = this.data[t][o]) && l[i]
          ? l[i]
  ...
  const p = { plural_forms: (t) => (1 === t ? 0 : 1) },
    ...
    h = (t, n, e) => {
      const r = new c({}),
        ...
        s = (t = "default", n, e, a, i) => (
          r.data[t] || o(void 0, t), r.dcnpgettext(t, n, e, a, i)
        ),
        u = (t) => t || "default",
        d = (t, n, r) => {
          let a = s(r, n, t);
          return e
            ? ((a = e.applyFilters("i18n.gettext_with_context", a, t, n, r)),
              e.applyFilters("i18n.gettext_with_context_" + u(r), a, t, n, r))
            : a;
        };
      if ((t && l(t, n), e)) {
        const t = (t) => {
      ...
      return {
        ...
        __: (t, n) => {
          ...
          return e
            ? ((r = e.applyFilters("i18n.gettext", r, t, n)),
              e.applyFilters("i18n.gettext_" + u(n), r, t, n))
            : r;
        },
        _x: d,
        _n: (t, n, r, a) => {
          ...
          return e
            ? ((i = e.applyFilters("i18n.ngettext", i, t, n, r, a)),
              e.applyFilters("i18n.ngettext_" + u(a), i, t, n, r, a))
            : i;
        },
        _nx: (t, n, r, a, i) => {
          let o = s(i, a, t, n, r);
        ...
        hasTranslation: (t, n, a) => {
          ...
          return (
            e &&
              ((o = e.applyFilters("i18n.has_translation", o, t, n, a)),
              (o = e.applyFilters("i18n.has_translation_" + u(a), o, t, n, a))),
            o
          );
        },
      };
